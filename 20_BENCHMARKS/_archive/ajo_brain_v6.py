"""AJO UniBrain v6: self-grow primary + specialists as bias. Merged path."""
import time
import numpy as np
...
if __name__ == "__main__":
    ...
    print(f"V6_OK steps=20 kinds=4 regions={r['regions']} winner={r['winner']} conf={r['conf']} drive={r['drive']} ms={ms:.2f} active={r['active']}")
